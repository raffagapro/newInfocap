...
const routes: Routes = [
	{
		path: "",
		loadChildren: () =>
			import("./walkthrougth/walkthrougth.module").then(
				(m) => m.WalkthrougthPageModule
			),
	},
	{
		path: "terms",
	...
	},
	{
		path: "recovery",
		loadChildren: () =>
			import("./login/recovery/recovery.module").then(
	...
	},
	{
		...
		loadChildren: () =>
			import("./user/profile-page/profile-page.module").then(
	...
	},
	{
		path: "user/map",
		loadChildren: () =>
			import("./user/mapa/mapa.module").then((m) => m.MapaPageModule),
		// canLoad: [AuthGuard, UserGuard],
	},
	{
		path: "user/profesional-list",
		loadChildren: () =>
			import("./user/profesional-list/profesional-list.module").then(
				(m) => m.ProfesionalListPageModule
			),
		// canLoad: [AuthGuard, UserGuard],
	},
	{
		...
		loadChildren: () =>
			import("./user/profesional-detail/profesional-detail.module").then(
				(m) => m.ProfesionalDetailPageModule
			),
		// canLoad: [AuthGuard, UserGuard],
	},
	{
		...
		loadChildren: () =>
			import("./user/solicitud-servicio/solicitud-servicio.module").then(
				(m) => m.SolicitudServicioPageModule
			),
		// canLoad: [AuthGuard, UserGuard],
	},
	/*
  ...
  */
	{
		...
		loadChildren: () =>
			import("./user/solicitudes/solicitudes.module").then(
	...
	},
	{
		...
		loadChildren: () =>
			import("./user/service-finished/service-finished.module").then(
				(m) => m.ServiceFinishedPageModule
			),
		// canLoad: [AuthGuard, UserGuard],
	},
	{
		...
		loadChildren: () =>
			import("./user/solicitud-detail/solicitud-detail.module").then(
				(m) => m.SolicitudDetailPageModule
			),
		// canLoad: [AuthGuard, UserGuard],
	},
	{
		...
		loadChildren: () =>
			import("./user/service-resume/service-resume.module").then(
				(m) => m.ServiceResumePageModule
			),
		// canLoad: [AuthGuard, UserGuard],
	},
	{
		...
		loadChildren: () =>
			import("./user/solicitud-status/solicitud-status.module").then(
				(m) => m.SolicitudStatusPageModule
			),
		// canLoad: [AuthGuard, UserGuard],
	},
	{
		...
		loadChildren: () =>
			import("./user/servicio-pagar/servicio-pagar.module").then(
				(m) => m.ServicioPagarPageModule
			),
		// canLoad: [AuthGuard, UserGuard],
	},
	{
		...
		loadChildren: () =>
			import("./user/service-report/service-report.module").then(
				(m) => m.ServiceReportPageModule
			),
		// canLoad: [AuthGuard, UserGuard],
	},
	{
		...
		loadChildren: () =>
			import("./user/servicio-pagar-forma/servicio-pagar-forma.module").then(
				(m) => m.ServicioPagarFormaPageModule
			),
		// canLoad: [AuthGuard, UserGuard],
	},
	{
		...
		loadChildren: () =>
			import("./user/eval-prof/eval-prof.module").then(
				(m) => m.EvalProfPageModule
			),
		// canLoad: [AuthGuard, UserGuard],
	},
	{
		...
		loadChildren: () =>
			import("./user/visita-detail/visita-detail.module").then(
				(m) => m.VisitaDetailPageModule
			),
		// canLoad: [AuthGuard, UserGuard],
	},
	{
		...
		loadChildren: () =>
			import("./user/notificaciones/notificaciones.module").then(
	...
	},
	{
		...
		loadChildren: () =>
			import("./user/prof-contactados-list/prof-contactados-list.module").then(
				(m) => m.ProfContactadosListPageModule
			),
		// canLoad: [AuthGuard, UserGuard],
	},
	{
		...
		loadChildren: () =>
			...
			).then((m) => m.SingleProfServicesPageModule),
		// canLoad: [AuthGuard, ProGuard],
	},
	{
		path: "user/urgen-service",
		loadChildren: () =>
			import("./user/urgen-service/urgen-service.module").then(
				(m) => m.UrgenServicePageModule
			),
		// canLoad: [AuthGuard, UserGuard],
	},
	{
		...
		loadChildren: () =>
			import("./profesional/home/home.module").then((m) => m.HomePageModule),
		// canLoad: [AuthGuard, ProGuard],
	},
	{
		path: "profesional/notificaciones",
		loadChildren: () =>
			import("./profesional/notificaciones/notificaciones.module").then(
				(m) => m.NotificacionesPageModule
			),
		// canLoad: [AuthGuard, ProGuard],
	},
	{
		...
		loadChildren: () =>
			import("./profesional/wallet/wallet.module").then(
	...
	},
	{
		...
		loadChildren: () =>
			import("./profesional/rating/rating.module").then(
	...
	},
	{
		...
		loadChildren: () =>
			import("./profesional/perfil/perfil.module").then(
	...
	},
	{
		...
		loadChildren: () =>
			import("./profesional/cat-perfiles/cat-perfiles.module").then(
				(m) => m.CatPerfilesPageModule
			),
		// canLoad: [AuthGuard, ProGuard],
	},
	{
		...
		loadChildren: () =>
			...
			).then((m) => m.SolicitudesDetailPageModule),
		// canLoad: [AuthGuard, ProGuard],
	},
	{
		...
		loadChildren: () =>
			...
			).then((m) => m.DefinicionServicioPageModule),
		// canLoad: [AuthGuard, ProGuard],
	},
	{
		...
		loadChildren: () =>
			...
			).then((m) => m.VisitaTecnicaPageModule),
		// canLoad: [AuthGuard, ProGuard],
	},
	{
		...
		loadChildren: () =>
			...
			).then((m) => m.AgendadosDetailPageModule),
		// canLoad: [AuthGuard, ProGuard],
	},
	{
		...
		loadChildren: () =>
			...
			).then((m) => m.AgendadosFinalizarPageModule),
		// canLoad: [AuthGuard, ProGuard],
	},
	{
		...
		loadChildren: () =>
			...
			).then((m) => m.ServiciosAdicionalesPageModule),
		// canLoad: [AuthGuard, ProGuard],
	},
	{
		...
		loadChildren: () =>
			...
			).then((m) => m.FinalizadosDetailsPageModule),
		// canLoad: [AuthGuard, ProGuard],
	},
	{
