      ...
      var RatingPage = /*#__PURE__*/function () {
        ...
        _createClass(RatingPage, [{
          ...
          value: function changeCategory() {
            ...
            axios__WEBPACK_IMPORTED_MODULE_6___default.a.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["API"] + "/supplier/evaluation/filtercategorie/".concat(this.categorySelected), {
              headers: {
