...
let SolicitudesPage = class SolicitudesPage {
    ...
    compare(a, b) {
        let firstDate = moment__WEBPACK_IMPORTED_MODULE_7__(a.created_date, 'DD/MM/YYYY');
        let secondDate = moment__WEBPACK_IMPORTED_MODULE_7__(b.created_date, 'DD/MM/YYYY');
