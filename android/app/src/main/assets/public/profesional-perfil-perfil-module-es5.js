(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["profesional-perfil-perfil-module"], {
    ...
    function hnL7(module, __webpack_exports__, __webpack_require__) {
      ...
      var _success_modal_success_modal_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
      /*! ./success-modal/success-modal.component */
      "yw4M");

      var PerfilPage = /*#__PURE__*/function () {
        function PerfilPage(us, lc, http, modalController) {
        ...
        _createClass(PerfilPage, [{
          ...
          value: function onUpdateUser() {
            ...
            this.lc.create({
              ...
              _this2.http.put('http://workintest.herokuapp.com/api/account', modUser, {
                headers: headers
              }).subscribe(function (resData) {
                loadingEl.dismiss(); // console.log(resData);
                ...
                if (resData['code'] === 200) {
                  ...
                  _this2.us.setUser(new src_app_model_user_model__WEBPACK_IMPORTED_MODULE_7__["User"](_this2.grabbedUser.id, resData['data'].name, resData['data'].last_name, img, resData['data'].email, resData['data'].phone1, resData['data'].phone2, _this2.grabbedUser.role, _this2.grabbedUser.access_token));
      ...
      PerfilPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_4__["Component"])({
        selector: 'app-perfil',
