        ...
        _createClass(ServicioPagarPage, [{
          ...
          value: function getServiceAditional() {
            if (this.servicesCosts && this.servicesCosts.addittional.length > 0) {
              return Math.floor(Number(this.servicesCosts.addittional.reduce(function (total, entity) {
          ...
          value: function getTotal() {
            ...
            return Math.floor(Number(this.getServiceAditional()) + Number(parseFloat(this.servicesCosts.amount_client)));
          }
        }, {
          key: "openMenu",
