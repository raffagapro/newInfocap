(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["agendados-agendados-module"], {
      ...
      var AgendadosPage = /*#__PURE__*/function () {
        ...
        _createClass(AgendadosPage, [{
          ...
          value: function ionViewWillEnter() {
            ...
            this.loadServices("3");
            this.loadServices("4"); // load visitas
            // this.loadServices("2");
          }
        }, {
          key: "loadServices",
          value: function loadServices(statusID) {
            ...
            this.lc.create({
              ...
              _this2.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_9__["API"] + "/supplier/requestservice/".concat(statusID), {
                ...
                if (statusID === "4") {
                  _this2.loadedStartedServices = resData["data"]; // console.log(this.loadedServices);
                } // if (statusID === "2") {
    ...
    function KG52(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_exports__["default"] = ".prof-cont {\n  box-shadow: 1px 8px 12px 0px rgba(0, 0, 0, 0.2);\n  margin-bottom: 10px;\n}\n\n.titleSelect {\n  font-size: 16px;\n  font-weight: bold;\n}\n\n.badge-text {\n  font-size: 10px;\n  margin-bottom: -2px;\n}\n\n.ticket {\n  color: red;\n  font-size: 11px;\n}\n\n.title {\n  font-size: 17px;\n}\n\n.superMarginTop {\n  margin-top: 60px;\n}\n\n.tapText {\n  font-size: 10px;\n}\n\n.iconFix {\n  margin-bottom: -2px;\n}\n\n.miniBtnTxt {\n  font-size: 9px;\n}\n\n.locate-cont {\n  margin-top: 5px;\n  border-radius: 50px;\n  height: 30px;\n  width: 30px;\n  display: inline-flex;\n  align-items: center;\n  text-align: center;\n  margin-left: auto;\n  margin-right: auto;\n  background-color: #009ACE;\n}\n\n.rating-text {\n  font-size: 12px;\n  margin-left: auto;\n  margin-right: auto;\n  display: inline-flex;\n}\n\n.ratingText {\n  font-size: 12px;\n  margin: 0;\n  padding: 0;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
      /***/
    },
