(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["agendados-agendados-module"], {
    ...
    function JRYn(module, __webpack_exports__, __webpack_require__) {
      ...
      var AgendadosPage = /*#__PURE__*/function () {
        function AgendadosPage(router, menuController, us, lc, solicitudServicio, route) {
          ...
          this.calendar = {
            ...
            dateFormatter: {
              formatWeekViewHourColumn: function formatWeekViewHourColumn(date) {
                var format_date = moment__WEBPACK_IMPORTED_MODULE_10__(date).format('h a');
                return format_date;
              }
            }
          };
          ...
          this.next = function () {
            _this.myCal.slideNext();
          };

          this.back = function () {
            _this.myCal.slidePrev();
          };

          this.nextAgended = function () {
            _this.myCalAgended.slideNext();
          };
          ...
          route.params.subscribe(function (val) {
            _this.eventSourceAgended = [];
            _this.eventSource = [];
            _this.loadedServices = [];
        ...
        _createClass(AgendadosPage, [{
                      ...
                      data.map(function (r) {
                        if (type === "2") {
                          ...
                          var new_event = {
                            title: {
                              id: r.id,
                              ticket: "#".concat(ticket_format),
                              type: r.type_request,
                              request_technical: r.request_technical[0]
                            },
                            startTime: startTime,
                            endTime: endTime,
                            allDay: false
                          ...
                          _this2.eventSource.push(_new_event);
                        }
                      });
          ...
          key: "formatDateTecnical",
          value: function formatDateTecnical(tecnical) {
            var date = tecnical.visit_date.split(' ');
          ...
          value: function loadServices(statusID) {
            ...
            this.lc.create({
              ...
              axios__WEBPACK_IMPORTED_MODULE_9___default.a.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_7__["API"] + "/supplier/requestservice/".concat(statusID), {
                ...
                _this3.loadedServices.map(function (r) {
                  r.timeFrom = Math.abs(moment__WEBPACK_IMPORTED_MODULE_10__(_this3.formatDate(r.date_required), 'DD MMM YYYY').diff(moment__WEBPACK_IMPORTED_MODULE_10__()));
                });
              }).then(function () {
                _this3.loadedServices = lodash__WEBPACK_IMPORTED_MODULE_12__["orderBy"](_this3.loadedServices, ['timeFrom']); // this.loadedServices = lodash.orderBy(this.loadedServices, function (dateObj) {
          ...
          value: function formatTime(hours, hoursFinal) {
            if (hours) {
              var startHour = moment__WEBPACK_IMPORTED_MODULE_10__(hours, 'hh:mm:ss').format('h:mm A');
              var endHour = moment__WEBPACK_IMPORTED_MODULE_10__(hoursFinal, 'hh:mm:ss').format('h:mm A');
              return "".concat(startHour, " - ").concat(endHour);
            }
          }
        }, {
          key: "openMaps",
          value: function openMaps(address) {
            window.open("https://maps.google.com/?q=".concat(address));
          }
        }, {
          key: "openMenu",
          ...
          key: "solicitudDetailTecnical",
          value: function solicitudDetailTecnical(serviceID, tecnical) {
            this.solicitudServicio.setID(serviceID);
          ...
          value: function onViewTitleChanged(title) {
            ...
            this.datesView = "".concat(week[0], " ").concat(primer.getDate(), " - ").concat(ultimo.getDate());
          }
        }, {
          key: "onViewTitleAgendedChanged",
          value: function onViewTitleAgendedChanged(title) {
            var week = title.split(' ');
            var primer = new Date(new Date().getFullYear(), 0, (week[3] - 1) * 7 + 3);
            var ultimo = new Date(new Date().getFullYear(), 0, (week[3] - 1) * 7 + 9);
            this.datesAgendedView = "".concat(week[0], " ").concat(primer.getDate(), " - ").concat(ultimo.getDate());
          }
        }, {
          key: "view",
      ...
      AgendadosPage.propDecorators = {
        myCal: [{
          ...
          args: [ionic2_calendar__WEBPACK_IMPORTED_MODULE_8__["CalendarComponent"]]
        }],
        myCalAgended: [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["ViewChild"],
    ...
    function KG52(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_exports__["default"] = ".prof-cont {\n  box-shadow: 0 3px 6px rgba(0, 0, 0, 0.16), 0 3px 6px rgba(0, 0, 0, 0.23);\n  margin-bottom: 10px;\n}\n\n.titleSelect {\n  font-size: 16px;\n  font-weight: bold;\n}\n\n.badge-text {\n  font-size: 10px;\n  margin-bottom: -2px;\n}\n\n.ticket {\n  color: red;\n  font-size: 11px;\n}\n\n.title {\n  font-size: 17px;\n}\n\n.superMarginTop {\n  margin-top: 60px;\n}\n\n.tapText {\n  font-size: 10px;\n}\n\n.iconFix {\n  margin-bottom: -2px;\n}\n\n.miniBtnTxt {\n  font-size: 9px;\n}\n\n.locate-cont {\n  margin-top: 5px;\n  border-radius: 50px;\n  height: 30px;\n  width: 30px;\n  display: inline-flex;\n  align-items: center;\n  text-align: center;\n  margin-left: auto;\n  margin-right: auto;\n  background-color: #009ace;\n}\n\n.rating-text {\n  font-size: 12px;\n  margin-left: auto;\n  margin-right: auto;\n  display: inline-flex;\n}\n\n.ratingText {\n  font-size: 12px;\n  margin: 0;\n  padding: 0;\n}\n\n.location_button {\n  margin: 5px 0;\n  padding: 2px 5px;\n  border: solid 2px #009ace;\n  border-radius: 10px;\n}\n\n.week-day-header {\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  align-items: center;\n  color: gray;\n  font-size: 16px;\n  font-weight: bold;\n}\n\n.btn-week-wallet {\n  --border-radius: 50%;\n  height: 3rem;\n  width: 3rem;\n}\n\n.calendar-event-inner {\n  border-radius: 4px;\n  font-size: 8px;\n  background-color: white;\n  border: 2px solid #9bafb6;\n}\n\n.category-event-inner {\n  background-color: #009ace;\n  color: white;\n  font-weight: bold;\n  font-size: 8px;\n  border-bottom-left-radius: 8px;\n  border-bottom-right-radius: 8px;\n}\n\n.urgent-event {\n  background-color: #eb445a;\n}\n\n.name-event-inner {\n  font-weight: bold;\n  font-size: 10px;\n  color: #009ace;\n}\n\n.iconFixCalendar {\n  background-color: #009ace;\n  border-radius: 40%;\n  width: 32px;\n  height: 16px;\n}\n\n.dates-text-calendar {\n  font-size: 16px;\n  font-weight: bold;\n  color: #009ace;\n}\n\n.icon-type-view {\n  color: #009ace;\n  margin-left: 8px;\n  margin-right: 8px;\n}\n\n.urgent-color {\n  color: #eb445a;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
      /***/
    },
    ...
    function hPVO(module, __webpack_exports__, __webpack_require__) {
      ...
      var _angular_common_locales_es__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! @angular/common/locales/es */
      "2Yyj");
      /* harmony import */


      var _angular_common_locales_es__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_angular_common_locales_es__WEBPACK_IMPORTED_MODULE_5__);
      /* harmony import */


      var _agendados_routing_module__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./agendados-routing.module */
      "Wl7L");
      /* harmony import */


      var _agendados_page__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! ./agendados.page */
      "JRYn");
      /* harmony import */
      ...
      AgendadosPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _agendados_routing_module__WEBPACK_IMPORTED_MODULE_6__["AgendadosPageRoutingModule"], ionic2_calendar__WEBPACK_IMPORTED_MODULE_8__["NgCalendarModule"]],
        declarations: [_agendados_page__WEBPACK_IMPORTED_MODULE_7__["AgendadosPage"]],
        providers: [{
