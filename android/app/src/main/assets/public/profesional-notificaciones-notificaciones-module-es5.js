    ...
    function Ekm(module, __webpack_exports__, __webpack_require__) {
      ...
      var NotificacionesPage = /*#__PURE__*/function () {
        ...
        _createClass(NotificacionesPage, [{
          ...
          value: function goToRequestDetail(solicitudId, notificationId, type, motive) {
                  ...
                  switch (_context2.prev = _context2.next) {
                    case 0:
                      axios__WEBPACK_IMPORTED_MODULE_7___default.a.put(src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["API"] + "/notification/view/".concat(notificationId), {
                        ...
                        _this2.solicitudServicio.setSolicitudType(type);

                        if (motive.includes('ocupada por un profesional')) {
                          _this2.solicitudServicio.setProfesional(0);
                        } else {
                          _this2.solicitudServicio.setProfesional(1);
                        }
                        ...
                        axios__WEBPACK_IMPORTED_MODULE_7___default.a.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["API"] + "/supplier/requestservicedetail/".concat(solicitudId), {
                          headers: {
                            Authorization: "Bearer ".concat(_this2.grabbedUser.access_token)
                          }
                        }).then(function (resData) {
                          if (resData.data.data.status_id > 1) {
                            _this2.router.navigate(['/profesional/agendados/agendados-detail']);
                          } else {
                            _this2.router.navigate(['/profesional/solicitudes/solicitudes-detail']);
                          }
                        });
                      })["catch"](function (err) {
                        console.log(err);
