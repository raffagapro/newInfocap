...
let AgendadosPage = class AgendadosPage {
    constructor(router, menuController, us, lc, solicitudServicio, route) {
        this.router = router;
        ...
        this.calendar = {
            ...
            dateFormatter: {
                formatWeekViewHourColumn: function (date) {
                    let format_date = moment__WEBPACK_IMPORTED_MODULE_10__(date).format('h a');
                    return format_date;
                },
            }
        };
    ...
    loadServices(statusID) {
        this.lc.create({
            ...
            loadingEl.present();
            axios__WEBPACK_IMPORTED_MODULE_9___default.a.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_7__["API"] + `/supplier/requestservice/${statusID}`, { headers: { Authorization: this.headers } }).then(resData => {
                loadingEl.dismiss();
                if (statusID === "3") {
                ...
                this.loadedServices.map(r => {
                    r.timeFrom = Math.abs(moment__WEBPACK_IMPORTED_MODULE_10__(this.formatDate(r.date_required), 'DD MMM YYYY').diff(moment__WEBPACK_IMPORTED_MODULE_10__()));
                });
            }).then(() => {
                this.loadedServices = lodash__WEBPACK_IMPORTED_MODULE_12__["orderBy"](this.loadedServices, ['timeFrom']);
    ...
    formatTime(hours, hoursFinal) {
        if (hours) {
            ...
            let endHour = moment__WEBPACK_IMPORTED_MODULE_10__(hoursFinal, 'hh:mm:ss').format('h:mm A');
    ...
    solicitudDetailTecnical(serviceID, tecnical) {
        this.solicitudServicio.setID(serviceID);
...
AgendadosPage.propDecorators = {
    myCal: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["ViewChild"], args: [ionic2_calendar__WEBPACK_IMPORTED_MODULE_8__["CalendarComponent"],] }],
    myCalAgended: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["ViewChild"], args: ['calendarAgended',] }]
};
...
/* harmony import */ var _agendados_routing_module__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./agendados-routing.module */ "Wl7L");
/* harmony import */ var _agendados_page__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./agendados.page */ "JRYn");
/* harmony import */ var ionic2_calendar__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ionic2-calendar */ "L+Ny");
...
AgendadosPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [
            ...
            _agendados_routing_module__WEBPACK_IMPORTED_MODULE_6__["AgendadosPageRoutingModule"],
