...
let AgendadosPage = class AgendadosPage {
    ...
    loadServices(statusID) {
        this.lc.create({
            ...
            loadingEl.present();
            axios__WEBPACK_IMPORTED_MODULE_10___default.a.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_8__["API"] + `/supplier/requestservice/${statusID}`, { headers: { Authorization: this.headers } }).then(resData => {
                loadingEl.dismiss();
                if (statusID === "3") {
    ...
    formatTime(hours) {
        if (hours) {
            ...
            let startHour = moment__WEBPACK_IMPORTED_MODULE_11__(wHours[0]).format('h:mm A');
            let endHour = moment__WEBPACK_IMPORTED_MODULE_11__(wHours[1]).format('h:mm A');
...
AgendadosPage.propDecorators = {
    myCal: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["ViewChild"], args: [ionic2_calendar__WEBPACK_IMPORTED_MODULE_9__["CalendarComponent"],] }],
