...
let RatingPage = class RatingPage {
    constructor(menuController, http, lc) {
    ...
    ngOnInit() {
        this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["API"] + `/supplier/categories`, { headers: this.headers }).subscribe(resData => {
