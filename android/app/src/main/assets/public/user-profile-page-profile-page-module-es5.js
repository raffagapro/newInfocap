        ...
        _createClass(ProfilePagePage, [{
          ...
          value: function ngOnInit() {
            ...
            this.userSub = this.us.loggedUser.subscribe(function (user) {
              ...
              _this.headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpHeaders"]().set('Authorization', 'Bearer ' + _this.grabbedUser.access_token); // updates to the most current info from DB

              _this.us.dbUserGrab(_this.grabbedUser.access_token, _this.grabbedUser.role);
            });
            var phone1;
            var phone2;
