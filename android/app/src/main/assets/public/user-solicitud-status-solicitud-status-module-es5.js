(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["user-solicitud-status-solicitud-status-module"], {
    ...
    function YjC(module, __webpack_exports__, __webpack_require__) {
      ...
      var _servicio_agendado_modal_servicio_agendado_modal_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
      /*! ./servicio-agendado-modal/servicio-agendado-modal.component */
      "Uol3");
      /* harmony import */


      var _solicitud_enviada_modal_solicitud_enviada_modal_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
      /*! ./solicitud-enviada-modal/solicitud-enviada-modal.component */
      "NPqd");
      /* harmony import */


      var _solicitud_rechazada_modal_solicitud_rechazada_modal_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
        ...
        _createClass(SolicitudStatusPage, [{
          ...
          value: function loadService(solicitudId) {
            ...
            this.lc.create({
              ...
              _this2.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_11__["API"] + "/client/requestservice/".concat(solicitudId), {
                ...
                _this2.wDate = moment__WEBPACK_IMPORTED_MODULE_8__(_this2.loadedService.created_date, 'YYYY-MM-DD').format('DD MMM YYYY');
              }, function (err) {
                loadingEl.dismiss();
                console.log(err);
              });
          ...
          value: function openWhatsapp() {
            window.open("https://api.whatsapp.com/send?phone=".concat(src_environments_environment__WEBPACK_IMPORTED_MODULE_11__["PHONE_PREFIX"]).concat(this.loadedService.suplierPhone1));
          }
        }, {
          key: "call",
