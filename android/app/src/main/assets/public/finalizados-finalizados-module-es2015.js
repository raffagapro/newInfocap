...
let FinalizadosPage = class FinalizadosPage {
    constructor(router, menuController, http, us, lc) {
        this.router = router;
    ...
    loadServices(statusID) {
        this.lc.create({
            ...
            loadingEl.present();
            this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_8__["API"] + `/supplier/requestservice/${statusID}`, { headers: this.headers })
                .subscribe(resData => {
