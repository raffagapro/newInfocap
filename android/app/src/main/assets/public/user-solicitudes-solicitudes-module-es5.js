(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["user-solicitudes-solicitudes-module"], {
      ...
      var SolicitudesPage = /*#__PURE__*/function () {
        ...
        _createClass(SolicitudesPage, [{
          ...
          value: function loadServices() {
            ...
            this.lc.create({
              ...
              _this2.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_10__["API"] + '/client/requestservices', {
                ...
                _this2.loadedServices = _this2.loadedServices.sort(_this2.compare);
              }, function (err) {
                console.log(err);
                loadingEl.dismiss();
              });
          ...
          value: function compare(a, b) {
            var firstDate = moment__WEBPACK_IMPORTED_MODULE_7__["utc"](a.created_date, 'DD/MM/YYYY HH:mm:ss').tz(moment__WEBPACK_IMPORTED_MODULE_7__["tz"].guess());
            var secondDate = moment__WEBPACK_IMPORTED_MODULE_7__["utc"](b.created_date, 'DD/MM/YYYY HH:mm:ss').tz(moment__WEBPACK_IMPORTED_MODULE_7__["tz"].guess());
    ...
    function TEEc(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_exports__["default"] = ".border {\n  border: 1px solid #009ace;\n  border-radius: 15px;\n  font-size: 12px;\n  height: 35px;\n}\n\n.prof-cont {\n  box-shadow: 0 3px 6px rgba(0, 0, 0, 0.16), 0 3px 6px rgba(0, 0, 0, 0.23);\n}\n\n.no-border {\n  padding-top: 2px;\n  padding-bottom: 2px;\n}\n\n.profileImg {\n  margin-left: 10px;\n  height: 75px;\n  width: 75px;\n}\n\n.titleSelect {\n  font-size: 16px;\n  font-weight: bold;\n}\n\n.badge-text {\n  font-size: 7px;\n}\n\n.textSelect {\n  font-size: 10px;\n  line-height: 1.4;\n  margin-bottom: 2px;\n}\n\n.ratingText {\n  font-size: 14px;\n  margin: 0;\n  padding: 0;\n}\n\n.locate-cont {\n  margin-top: 5px;\n  border-radius: 50px;\n  height: 30px;\n  width: 30px;\n  display: inline-flex;\n  align-items: center;\n  text-align: center;\n  margin-left: auto;\n  margin-right: auto;\n  background-color: #009ace;\n}\n\n.rating-text {\n  font-size: 18px;\n  margin-left: auto;\n  margin-right: auto;\n  display: inline-flex;\n}\n\n.ticket {\n  color: red;\n  font-size: 11px;\n}\n\n.green-color {\n  color: #39ae50;\n}\n\n.bg-green-color {\n  background-color: #39ae50;\n}\n\n.grey-color {\n  color: #8e8c89;\n}\n\n.bg-grey-color {\n  background-color: #8e8c89;\n}\n\n.red-color {\n  color: red;\n}\n\n.bg-red-color {\n  background-color: red;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
      /***/
    },
