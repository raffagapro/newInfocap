(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
    ...
    function Sy1n(module, __webpack_exports__, __webpack_require__) {
      ...
      var _model_user_model__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
      /*! ./model/user.model */
      "UbF0");
      /* harmony import */
      ...
      var _services_google_google_service__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(
      /*! ./services/google/google.service */
      "fPD/");

      var AppComponent = /*#__PURE__*/function () {
        function AppComponent(platform, router, menuCtrl, as, us, notificationService, screenOrientation, googleService) {
          ...
          this.whatsappPhone = "".concat(src_environments_environment__WEBPACK_IMPORTED_MODULE_11__["PHONE_PREFIX"], "939304991");
        ...
        _createClass(AppComponent, [{
          ...
          value: function initializeApp() {
            ...
            this.platform.ready().then(function () {
              _this3.screenOrientation.lock("portrait");
              ...
              _this3.menuCtrl.enable(false, _model_user_model__WEBPACK_IMPORTED_MODULE_10__["UserRoles"].PROFESSIONAL);

              _this3.menuCtrl.enable(false, _model_user_model__WEBPACK_IMPORTED_MODULE_10__["UserRoles"].USER);
              ...
              if (v) {
                _this4.us.loggedUser.subscribe(function (user) {
                  ...
                  if (!_this4.firstLoad && user.id !== null) {
                    ...
                    if (_this4.user.role === _model_user_model__WEBPACK_IMPORTED_MODULE_10__["UserRoles"].USER) {
                ...
                while (1) {
                  switch (_context2.prev = _context2.next) {
                    case 0:
                      _context2.prev = 0;
                      _context2.next = 3;
                      return axios__WEBPACK_IMPORTED_MODULE_13___default.a.get("".concat(src_environments_environment__WEBPACK_IMPORTED_MODULE_11__["API"], "/").concat(type, "/notification"), {
                        headers: {
    ...
    function a1SQ(module, __webpack_exports__, __webpack_require__) {
      ...
      var ProSolicitud = function ProSolicitud(clientLastName, clientName, clientImg, clientPhone, prof, images, category_id, categoryName, date_required, created_date, description, hours, hours_final, id, status_id, cost, supplierLastName, supplierName, ticket_number, aditional, evaluationService, type) {
        ...
        _createClass(ServiceRejectModalComponent, [{
          ...
          value: function getUrl() {
            if (!this.loadedInfo.img_client_profile || this.loadedInfo.img_client_profile === '/' || this.loadedInfo.img_client_profile === 'http://167.71.251.136/storage/') {
              ...
              return "url(".concat(this.loadedInfo.img_client_profile, ")");
            }
          }
        }, {
          key: "ngOnDestroy",
    ...
    function p1Kg(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, "IMAGE_URL_BLANK_", function () {
        return IMAGE_URL_BLANK_;
      });

      var IMAGE_URL_BLANK = 'http://167.71.251.136/storage/';
      var IMAGE_URL_BLANK_ = 'http://167.71.251.136/storage/';
      /***/
    },
      ...
      */
      {
        ...
        loadChildren: function loadChildren() {
          ...
          [__webpack_require__.e("default~agendados-agendados-module~finalizados-finalizados-module~profesional-notificaciones-notific~62cb1172"), __webpack_require__.e("profesional-notificaciones-notificaciones-module")]).then(__webpack_require__.bind(null,
    ...
    function zMwU(module, __webpack_exports__, __webpack_require__) {
      ...
      var ProSolicitudService = /*#__PURE__*/function () {
        ...
        _createClass(ProSolicitudService, [{
          ...
          key: "setProfesional",
          value: function setProfesional(prof) {
