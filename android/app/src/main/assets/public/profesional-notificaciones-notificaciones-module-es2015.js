...
let NotificacionesPage = class NotificacionesPage {
    ...
    goToRequestDetail(solicitudId, notificationId, type, motive) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            axios__WEBPACK_IMPORTED_MODULE_7___default.a.put(src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["API"] + `/notification/view/${notificationId}`, { viewed: 1, }, { headers: { Authorization: `Bearer ${this.grabbedUser.access_token}` } }).then(resData => {
                ...
                axios__WEBPACK_IMPORTED_MODULE_7___default.a.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["API"] + `/supplier/requestservicedetail/${solicitudId}`, { headers: { Authorization: `Bearer ${this.grabbedUser.access_token}` } }).then(resData => {
